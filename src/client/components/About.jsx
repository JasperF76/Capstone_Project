            ...
            <div className="about_body">
                <div className="paragraph_1"><img src={MeInATree} alt="Me climbing" className='arborist_image' />
                    <p>
                        ...
                        However, work as an arborist is very physically demanding, and there are a number of ways to be injured doing my former job.
                        A back injury had me off for a whole year in 2020, and then a neck injury sidelined me in 2022, and those two injuries ultimately lead to me being unable to return to the profession that I'd dedicated more than half of my life to.
                    </p>
                ...
                <div className="paragraph_2">
                    <p>
                        ...
                        And hopefully, fingers crossed, that new career is going to be as a software developer! After 3 months of very educational, very rewarding, and, at times, very <i>frustrating</i> instruction, I have managed to build this, my very first website.
                ...
                <div className='paragraph_3'>
                    ...
                    <p>
                        ...
                        This site introduces you to some of the more iconic trees around the world, from the world's oldest known tree, Methuselah, to the largest tree by volume, General Sherman.
                ...
                <div className='paragraph_4'>
                    <p>
                        ...
                        <br /><br />
                        My loving wife and daughter, <i>Janine</i> and  <i>Jasmine</i>, for all their support, encouragement, and acceptance through the past couple of years of me navigating finding new employment (and for talking me out of quitting coding a few days after starting javascript)
                        <br /><br />
