    ...
    <div className='App'>
      ...
      <div>
        ...
        <div className="ticker">
          ...
          <div className="ticker__item">Although it is commonly referred to by many as an "apple", the type of fruit eaten by Adam and Eve in the Garden of Eden is not identified specifically in the bible, only being referred to as "fruit"...</div>
          ...
          <div className="ticker__item">The world’s smallest tree is the dwarf willow, which lives in cold and high parts of the world. At only 6 centimeters in height, the jury’s out on whether this plant can really be called a tree, but it is, by definition, a single-stemmed woody plant which produces tiny lateral branches...</div>
